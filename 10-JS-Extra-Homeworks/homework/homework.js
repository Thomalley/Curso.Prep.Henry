...
function deObjetoAmatriz(objeto) {
  ...
  for (propiedades in objeto) {
    newArray.push([propiedades, objeto[propiedades]]);
  }
  return newArray;
}
...
function capicua(numero) {
  ...
  var numeroSplit = numeroStr.split("");
  var numReverse = numeroSplit.reverse();
  if (numeroStr === numReverse.join("")) {
    return "Es capicua";
  }
...
function sortArray(arr) {
  ...
  arr.sort(function (elementoA, elementoB) {
